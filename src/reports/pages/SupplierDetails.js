    ...
    useEffect(() => {
        const fetchSuppliers = async () => {
            try {
                ...
                // let dataSet = Math.round((responseData.supplier.length) / 3);
                // console.log(responseData.supplier.length);
                // console.log(dataSet);
                ...
                //
                //     }
                // responseData.supplier.map((obj,i) => {
                //     let ordered = Object.keys(obj).sort().reduce( //sorting gl grades ascending order(A,B.C)
                //         (obj, key) => {
                //             obj[key] = result[key];
                //             return obj;
                //         },
